      ...
      <div className="container">
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', fontSize: '1.1rem', color: 'var(--color-text-muted)', lineHeight: '1.8' }}>
          <p style={{ marginBottom: '1.5rem' }}>
            Welcome to ZED COMPUTERS, your ultimate destination for premium gadgets, computers, and top-tier tech solutions. Founded with a passion for technology and a commitment to customer satisfaction, we aim to provide an unparalleled shopping experience.
          </p>
          <p style={{ marginBottom: '1.5rem' }}>
          ...
          <p style={{ marginBottom: '1.5rem' }}>
            But we are more than just a retail store. Our expert technicians are always ready to assist you with comprehensive repair services, system upgrades, and professional tech support. At ZED COMPUTERS, we believe in building lasting relationships with our customers through trust, quality, and exceptional service.
          </p>
            <p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 250px), 1fr))', gap: '2rem', marginTop: '4rem', marginBottom: '4rem' }}>
            <div style={{ padding: '2rem', background: 'var(--color-bg-accent-card)', border: '1px solid var(--color-border-subtle)', textAlign: 'center' }}>
              ...
              <h3 style={{ marginBottom: '0.5rem', color: 'var(--color-blue)' }}>5+ Years Experience</h3>
              <p style={{ opacity: 0.8, fontSize: '0.9rem' }}>Serving customers since 2019</p>
            </div>
            <div style={{ padding: '2rem', background: 'var(--color-bg-accent-card)', border: '1px solid var(--color-border-subtle)', textAlign: 'center' }}>
              <div style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>🛠️</div>
              <h3 style={{ marginBottom: '0.5rem', color: 'var(--color-blue)' }}>1000+ Devices Repaired</h3>
              <p style={{ opacity: 0.8, fontSize: '0.9rem' }}>Computers, laptops, tablets and more</p>
            </div>
            <div style={{ padding: '2rem', background: 'var(--color-bg-accent-card)', border: '1px solid var(--color-border-subtle)', textAlign: 'center' }}>
              <div style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>⚡</div>
              <h3 style={{ marginBottom: '0.5rem', color: 'var(--color-blue)' }}>Same-Day Service</h3>
          ...
          <div style={{ marginTop: '4rem', width: '100%', height: '400px', background: 'var(--color-bg-card)', border: '1px dashed var(--color-border-subtle)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--color-text-muted)' }}>
            {/* TODO: Add real ZED Computers team photo here */}
            <p>Image Placeholder: ZED Computers team</p>
          </div>
        </div>
      </div>
  );
